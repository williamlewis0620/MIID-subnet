...
async def test():
    query_files = [
        # "/work/54/miners/pub54-2/net54_uid192/netuid54/miner/validator_59/run_2025-08-24-08-53/query.json",
        ...
        # "/work/54/miners/pub54-2/net54_uid192/netuid54/miner/validator_59/run_2025-08-24-10-44/query.json",
        ...
        # "/work/54/tasks_fvs/query_5DUB_2025-08-18-17-43_15_5CfP.json",
        "/work/54/tasks_fvs/query_5DUB_2025-08-18-17-43_15_5CfP.json",
        "/work/54/tasks_fvs/query_5DUB_2025-08-18-17-43_15_5CfP.json",
        "/work/54/tasks_fvs/query_5DUB_2025-08-18-17-43_15_5CfP.json",
        "/work/54/tasks_fvs/query_5DUB_2025-08-18-17-43_15_5CfP.json",
    ...
    for i, query_data in enumerate(query_datas):
        tasks.append(solve_task(query_data['names'], query_data['query_template'], timeout=700.0))
    results = await asyncio.gather(*tasks)
    # from types import SimpleNamespace
    ...
    #         variations={name: list(results[i][name]) for name in query_data['names']}
    #     ))
    # # rule_based=rule_based,
    # rule_based = {"selected_rules": query_datas[0]["parsed_result"]["selected_rules"], 
    #               "rule_percentage": query_datas[0]["parsed_result"]["rule_percentage"] * 100}
    
    # scores, metric = get_name_variation_rewards(
    #     None, 
    #     seed_names=query_datas[0]['names'], 
    #     responses=responses,
    #     uids=range(len(query_datas)),
    #     variation_count=query_datas[0]["parsed_result"]["variation_count"],
    #     phonetic_similarity=query_datas[0]["parsed_result"]["phonetic_similarity"],
    #     orthographic_similarity=query_datas[0]["parsed_result"]["orthographic_similarity"],
    #     rule_based=rule_based,
    # )
